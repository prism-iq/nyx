#!/usr/bin/env python3
"""
DAEMON CANAL DROIT - Système d'écoute stéréo Flow
Port 8095 - Analyse audio temps réel canal droit
"""
...
class CanalDroit:
    ...
    def setup_routes(self):
        ...
        def start_stream():
            ...
            return jsonify({'status': 'stream démarré (canal droit)'})
...
if __name__ == '__main__':
    canal_droit = CanalDroit()
    print("🎧 CANAL DROIT démarré sur port 8095")
    canal_droit.app.run(host='0.0.0.0', port=8095, debug=False)